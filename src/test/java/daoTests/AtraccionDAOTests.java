...
public class AtraccionDAOTests {
	...
	public void cargarAtraccionesTest() {
		...
		Atraccion atraccion3 = new Atraccion(3, "La Comarca", 3, 1, 150, 1, "Aventura", true);
	...
	public void insertTest() {
		...
		Atraccion atraccion2 = new Atraccion(2, "Minas Tirith", 2, 2.5, 25, 1, "Aventura", true);
		Atraccion atraccion3 = new Atraccion(3, "La Comarca", 3, 1, 150, 1, "Aventura", true);
		Atraccion atraccion4 = new Atraccion(4, "Mordor", 3, 1, 150, 1, "Aventura", true);
	...
	public void findTest() {
		AtraccionDAO atraccionDAO = DAOFactory.getAtraccionDAO();
		Atraccion atraccionEsperada = new Atraccion(1, "Moria", 1, 1, 6, 1, "Aventura", true);
	...
	public void updateTest() {
		AtraccionDAO atraccionDAO = DAOFactory.getAtraccionDAO();
		Atraccion atraccion1 = new Atraccion(1, "Moria", 1, 2, 6, 1, "Aventura", true);
		Atraccion atraccion2 = new Atraccion(2, "Minas Tirith", 2, 2.5, 25, 1, "Aventura", true);
		Atraccion atraccion3 = new Atraccion(3, "La Comarca", 3, 1, 150, 1, "Aventura", true);
