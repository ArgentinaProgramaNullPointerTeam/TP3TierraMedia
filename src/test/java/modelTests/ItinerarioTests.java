...
public class ItinerarioTests {
	...
	public void setup() {
		...
		sugerencia1 = new Atraccion(1, "Edoras", 5, 0.5, 2, 1, "Aventura", true);
		sugerencia2 = new Atraccion(1, "Isengard", 5, 1, 2, 1, "Aventura", true);
		sugerencia3 = new Atraccion(3, "Rivendel", 10, 1, 2, 1, "Aventura", true);
