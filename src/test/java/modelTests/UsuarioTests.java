...
public class UsuarioTests {
	...
	@Before
	public void setup() {
		usuario = new Usuario(1, "Sam", "pass", 1, "Aventura", 50, 3, false, true);
		u1 = new Usuario(2, "pepito", "pass", 1, "Aventura", 100, 100, false, true);

		a1 = new Atraccion(1, "a1", 10, 3, 20, 1, "Aventura", true);
		a2 = new Atraccion(2, "a2", 4, 2.5, 20, 1, "Aventura", true);
		a3 = new Atraccion(3, "a3", 2, 1, 20, 1, "Aventura", true);
		...
		packCuatro.add(a2);
		packCuatro.add(a4);
		p4 = new PromocionAbsoluta(4, "Pack Cuatro", 1, "Aventura", 2, packCuatro, "Absoluta", 5, true);
	}
	...
	public void comprarTestDinero() {
		...
		Producto sugerenciaAceptada = new Atraccion(5, "Rivendel", 20, 1.5, 2, 1, "Aventura", true);
